...
var ServerConfiguration = {
    ...
    //开启OMS系统
    StartOMS: true,
    OMSPath: "http://115.28.129.13:8081/oms-api",    //Path: "http://192.168.1.102:8080/oms-api",    //Path: "http://192.168.0.130:8080/oms-api",
    //开启BMS系统
    StartBMS: true,
    //BMS请求地址
    BMSPath: "http://115.28.129.13:8081/bms-api",
    //是否启动开发,True的话全部菜单可用，false的话全部菜单与数据库的权限对接
    Version: "${version}",
    IsDevelop: false,
    EnvironmentDisplay:"（测试环境）",
