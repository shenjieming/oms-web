    ...
    .factory("$OMSMenuService", function () {
        ...
        service.push({
            ...
            detail: [
                ...
                { name: "待发货", url: "#/app/oms/order/toshipped", state: "app.oms.order.toshipped" },
        ...
        service.push({
            ...
            detail: [
                ...
                { name: "待发货", url: "#/app/oms/stock/toshipped", state: "app.oms.stock.toshipped" },
