    ...
    return {
        ...
        link: function ($scope, element, attrs) {
            ...
            var modelConfig = {
                ...
                title: "计费单选择", width: "100%", position: [0], height: "90%", buttons: { "确定": function () { $scope.Service.GetSelectedBillDetail(function (list) { $scope.ngBillList.fixed(list); $scope.ngBillList.hide(); }) }, "关闭": function () { $scope.ngBillList.hide(); } }, open: function () { $scope.Integrated.BillList = new Array(); $scope.Service.SelectBill = new Array(); $scope.Integrated.DataQuery({}); }
            }
